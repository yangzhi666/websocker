 ...
 * @Date: <P>CREATE IS 2018/9/25 16:29</P>
 **/
@Component
public class EchoHandler implements WebSocketHandler {
    ...
    public Mono<Void> handle(WebSocketSession webSocketSession) {
        return webSocketSession.send(webSocketSession.receive().map(msg -> webSocketSession.textMessage("服务端返回：jack ->" + msg.getPayloadAsText())));
    }
}
